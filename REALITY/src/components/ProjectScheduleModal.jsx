...
import {
    ...
    Lock, CaretDown, DotsThreeOutlineVertical, PencilSimple,
                                                ...
                                                <td style={{ padding: '20px 16px', textAlign: 'right', borderTopRightRadius: '16px', borderBottomRightRadius: '16px' }}>
                                                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: '12px' }}>
                                                        <div style={{ display: 'flex', gap: '6px' }}>
                                                            ...
                                                            {(user?.role === 'Admin' || user?.role === 'Builder') && (
                                                                <>
                                                                    <ActionButton icon={<Lock size={14} />} label="Approve" title="Approve Reschedule" color="#10b981" onClick={() => handleAction(task, 'approve')} />
                                                                    <ActionButton icon={<Lock size={14} />} label="Baseline" title="Lock Baseline" onClick={() => handleAction(task, 'baseline')} />
                                                                </>
                                                            )}
                                                        </div>
