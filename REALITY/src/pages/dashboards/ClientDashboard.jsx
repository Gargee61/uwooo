...
const ClientDashboard = () => {
    ...
    const fetchAllData = async () => {
        try {
            ...
            // In real app, filter by user.id. For demo, match by role or just pick first.
            const userProject = projectsRes.data.find(p => p.assignedTo?._id === user?.id) || projectsRes.data[0];
